...
plan1 = Plan.create!(user_id: user1.id, genre_id: genre1_1.id, name: "Controllerの作成", deadline: Date.today + 1,
                     status: "進行中")
plan2 = Plan.create!(user_id: user1.id, genre_id: genre1_2.id, name: "TOEIC", deadline: Date.today + 1, status: "進行中")
plan3 = Plan.create!(user_id: user1.id, genre_id: genre1_3.id, name: "レンダリング", deadline: Date.today + 1, status: "進行中")
